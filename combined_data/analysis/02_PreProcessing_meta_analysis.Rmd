...
pacman::p_load(devtools, phyloseq, tidyverse, dada2, xlsx, install = FALSE)
```
...
# Would only like to keep ASV 1089, 1596, 1760, 2802, 2989, 982 everything else is trash
...
write.xlsx(tax_mat, file = "tax_mat.xlsx",
       sheetName = "tax_mat", append = FALSE)

save(tax_mat,
     file = "combined_data/data/02_PreProcessing/tax_max.csv")
```
