...
scaled_total_seqs_df %>%
  ...
  labs(title = "Scaled Sequencing Depth at 326") + 
  theme_bw()
...
This means we explain 46% of the variation in the data in these two axes, which is almost exactly the same as the previous plot with the Sorensen Dissimilarity. 
...
- Axis 1 = ~46% of variation  
- Axis 2 = ~15% of variation 

This means we explain *61*% of the variation in the data in these two axes (!!!), which is significantly more than the previous plots with the taxonomic dissimilarity measures. 
...
wUNI_gut_section_nmds <- 
  ...
  scale_color_manual(values = c("blue3", "deeppink4", "darkorange3")) + 
  theme_bw()
wUNI_gut_section_nmds

# Plot the PCoA on diet
wUNI_diet_nmds <- 
  plot_ordination(
    physeq = scaled_rooted_physeq,
    ordination = scaled_wUNI_nmds,
    ...
    shape = "Host_Diet",
    title = "Weighted Unifrac NMDS") +
  geom_point(size=5, alpha = 0.5, aes(color = Host_Diet)) +
  scale_shape_manual(values = c(15,16,17, 18)) +
  scale_color_manual(values = c("blue3", "deeppink4", "darkorange3", "aquamarine4")) + 
  theme_bw()
wUNI_diet_nmds
```
