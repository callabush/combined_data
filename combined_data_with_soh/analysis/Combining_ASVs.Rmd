...
load("combined_data_with_soh/data/angert_meta_analysis/noChimeras_ASV_table.RData")
...
colnames(noChimeras_ASV_table_angert) <- 
  substr(colnames(noChimeras_ASV_table_angert), 0, 142)

# Load Bikrim ASV table
load("combined_data_with_soh/data/Bikrim_analysis/noChimeras_ASV_table.RData")
noChimeras_ASV_table_bikrim <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim 147 bp of left of sequence and 66 from the right
colnames(noChimeras_ASV_table_bikrim) <- 
  substr(colnames(noChimeras_ASV_table_bikrim), 148, 289)

# Load Alessandro ASV tables
## Load 2011 Illumina run
load("combined_data_with_soh/data/Alessandro_2011/noChimeras_ASV_table.RData")
noChimeras_ASV_table_alessandro_2011 <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim 163 bp of left of sequence and 82 bp from the right
colnames(noChimeras_ASV_table_alessandro_2011) <- 
  substr(colnames(noChimeras_ASV_table_alessandro_2011), 164, 305)

## Load 2017 Illumina run 
load("combined_data_with_soh/data/Alessandro_2017/noChimeras_ASV_table.RData")
noChimeras_ASV_table_alessandro_2017 <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim 185 bp of left of sequence and 100 bp from the right
colnames(noChimeras_ASV_table_alessandro_2017) <- 
  substr(colnames(noChimeras_ASV_table_alessandro_2017), 186, 327)

# Load Soh ASV tables
load("combined_data_with_soh/data/Soh_analysis/noChimeras_ASV_table.RData")
noChimeras_ASV_table_soh <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim 9 bp of left of sequence
colnames(noChimeras_ASV_table_soh) <- 
  substr(colnames(noChimeras_ASV_table_soh), 10, 151)
...
write.table(asv_tab, "combined_data_with_soh/data/01_DADA2/ASV_counts.tsv", sep = "\t", quote = FALSE, col.names = NA)
# Write count table with ASV sequence names
write.table(noChimeras_ASV_table, "combined_data_with_soh/data/01_DADA2/ASV_counts_withSeqNames.tsv",
            sep = "\t", quote = FALSE, col.names = NA)
# Write out the fasta file for reference later on for what seq matches what ASV
asv_fasta <- c(rbind(asv_headers, asv_seqs))
# Save to a file!
write(asv_fasta, "combined_data_with_soh/data/01_DADA2/ASVs.fasta")


# SECOND, let's save the taxonomy tables 
# Write the table 
write.table(asv_tax, "combined_data_with_soh/data/01_DADA2/ASV_taxonomy.tsv", sep = "\t", quote = FALSE, col.names = NA)
...
save(collapse_noChimeras_ASV_table,
     file = "combined_data_with_soh/data/01_DADA2/noChimeras_ASV_table.RData")
save(asv_tab, file = "combined_data_with_soh/data/01_DADA2/ASV_counts.RData")
