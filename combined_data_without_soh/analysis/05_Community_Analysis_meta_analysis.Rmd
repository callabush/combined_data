...
This means we explain *68*% of the variation in the data in these two axes (!!!), which is significantly more than the previous plots with the taxonomic dissimilarity measures. 
...
wUNI_gut_section_nmds <- 
  ...
  scale_color_manual(values = c("blue3", "deeppink4", "goldenrod", "magenta")) + 
