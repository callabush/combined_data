...
1. Combine ASV sequence tables from Alessandro data, Bikrim data, Angert data, Soh
...
load("with_pygmy/data/Angert_meta_analysis/noChimeras_ASV_table.RData")
noChimeras_ASV_table_angert <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim 16 bp of right of sequence
colnames(noChimeras_ASV_table_angert) <- 
  substr(colnames(noChimeras_ASV_table_angert), 16, 144)
...
#Trim 142 bp of left of sequence and 66 from the right
colnames(noChimeras_ASV_table_bikrim) <- 
  substr(colnames(noChimeras_ASV_table_bikrim), 142, 270)
...
#Trim 184 bp of left of sequence and 82 bp from the right
colnames(noChimeras_ASV_table_alessandro_2011) <- 
  substr(colnames(noChimeras_ASV_table_alessandro_2011), 184, 312)
...
#Trim 201 bp of left of sequence and 100 bp from the right
colnames(noChimeras_ASV_table_alessandro_2017) <- 
  substr(colnames(noChimeras_ASV_table_alessandro_2017), 201, 329)
...
#Trim 24 bp of left of sequence
colnames(noChimeras_ASV_table_soh) <- 
  substr(colnames(noChimeras_ASV_table_soh), 24, 152)

#load pygmyfish ASV tables
load("with_pygmy/data/pygmyfish/noChimeras_ASV_table.RData")
noChimeras_ASV_table_pygmy <- noChimeras_ASV_table
rm(noChimeras_ASV_table)

#Trim bp of left of sequence
colnames(noChimeras_ASV_table_pygmy) <- 
  substr(colnames(noChimeras_ASV_table_pygmy), 0, 128)
...
noChimeras_ASV_table <-  
  ...
  table6 = noChimeras_ASV_table_pygmy)
```
...
write.table(asv_tab, "combined_data_with_pygmy/data/01_DADA2/ASV_counts.tsv", 
            sep = "\t", quote = FALSE, col.names = NA)
# Write count table with ASV sequence names
write.table(noChimeras_ASV_table, "combined_data_with_pygmy/data/01_DADA2/ASV_counts_withSeqNames.tsv",
            sep = "\t", quote = FALSE, col.names = NA)
# Write out the fasta file for reference later on for what seq matches what ASV
asv_fasta <- c(rbind(asv_headers, asv_seqs))
# Save to a file!
write(asv_fasta, "combined_data_with_pygmy/data/01_DADA2/ASVs.fasta")


# SECOND, let's save the taxonomy tables 
# Write the table 
write.table(asv_tax, "combined_data_with_pygmy/data/01_DADA2/ASV_taxonomy.tsv", sep = "\t", quote = FALSE, col.names = NA)
...
save(collapse_noChimeras_ASV_table,
     file = "combined_data_with_pygmy/data/01_DADA2/noChimeras_ASV_table.RData")
save(asv_tab, file = "combined_data_with_pygmy/data/01_DADA2/ASV_counts.RData")
